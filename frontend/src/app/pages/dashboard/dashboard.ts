...
export class Dashboard {
  ...
  reports = [
    ...
    { name: 'Perfect Attendance Certificates', type: 'Certificate', by: 'Principal', date: 'May 30, 2026' },
    { name: 'Quarterly Financial Report', type: 'Finance', by: 'Principal', date: 'May 30, 2026' },
  ];
}